...
- [fakers.Fakers](https://github.com/DiUS/java-faker)
## VideoLectures
...
- `RandomStorePopulator` - utility class that will populate out store/category with fake data using `fakers.Fakers` lib
...
- connection of `fakers.Fakers` and generation of random product names, prices and rates **(30%)**;
